...
export const towerDefinitions = {
  "fork-knight": {
    ...
    levels: [
      { damage: 18, range: 112, cooldownTicks: 18, upgradeCost: 55 },
      { damage: 30, range: 122, cooldownTicks: 16, upgradeCost: 90 },
      { damage: 48, range: 136, cooldownTicks: 14, upgradeCost: null },
    ],
  },
  "discount-wizard": {
    id: "discount-wizard",
    ...
    supportCooldownPercent: 0,
    levels: [
      { damage: 27, range: 156, cooldownTicks: 34, upgradeCost: 80 },
      { damage: 43, range: 169, cooldownTicks: 31, upgradeCost: 125 },
  ...
  bardbarian: {
    ...
    levels: [
      { damage: 8, range: 136, cooldownTicks: 48, upgradeCost: 70 },
      { damage: 14, range: 149, cooldownTicks: 43, upgradeCost: 110 },
